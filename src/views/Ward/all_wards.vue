...
ward...">
                            ...
                            <div
                                ...
                                <RouterLink to="/
ward/add" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded bg-indigo-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Number of Bed(s)</th>
                                ...
                                <tbody>
                                    <tr @click="goToLink(
                                        ward._id)" v-for="(ward, index) in wards" :key="index"
                                        ...
                                        <td class="px-4 py-2">
                                            <span
                                                class="bg-primary-100 text-primary-800 text-md font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ index + 1 }}</span>
                                        </td>
                                        <th scope="row"
                                            class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="iMac Front Image" class="w-auto h-8 mr-3 rounded-full">
                                            {{ ward.name }}&#34;
                                        </th>
                                        <td
...
export default {
    ...
    methods: {
        ...
        goToLink(id) {
            this.$router.push(`/ward/${id}/details`)
        }
    }
}
</script>
