<template>
    <main>
        <dashboardVue title="Assigned Patient" />
                    ...
                    <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                        <div
                            ...
                            <div class="flex items-center flex-1 space-x-4">
                                <h5>
                                    <span class="text-gray-500">All Assigned Patients: </span>
                                    <span class="dark:text-white">(1k)</span>
                                </h5>
                            ...
                            <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                                ...
                                <div class="relative mt-1 lg:w-96">
                                    ...
                                    <input type="text" name="email" id="topbar-search"
                                        class="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Search patient...">
                                </div>
                            </form>
                            <div
                                class="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                                <RouterLink to="/patient/add"
                                    class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded bg-indigo-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Date of Visit</th>

                                    </tr>
                                </thead>
                                <tbody>
                                    <tr @click="goToLink(patient._id)" v-for="(patient, index) in patients" :key="index"
                                        ...
                                        <td class="px-4 py-2">
                                            <span
                                                class="bg-primary-100 text-primary-800 text-md font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{
                                                    index + 1 }}</span>
                                        </td>
                                        <th scope="row"
                                        ...
                                        <td
                                            class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                                            <span
                                                class="bg-yellow-300 text-xs text-white font-medium me-2 px-2.5 py-0.5">
                                                Admitted </span>
                                        </td>
                        ...
                        <div class="p-3">
                            <button type="button"
                                class="text-white gap-1 bg-gradient-to-r from-red-700 to-red-600  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <Icon icon="icon-park-outline:delete" width="1.2em" height="1.2em" />
                                Delete
                            </button>
                            <button type="button"
                                class="text-white bg-green-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <Icon icon="flowbite:edit-outline" width="1.5em" height="1.5em" />
                                Edit
    ...
    methods: {
        async fetchAssignedPatients() {
            ...
            try {
                ...
                if (!patientsData || !Array.isArray(patientsData)) {
                    console.error('No patients data found or invalid format');
                    return;
                }

                // Reset assignedPatients before fetching new data
                this.assignedPatients = [];

                // Fetch each patient's details
                for (const patient of patientsData) {
                    if (patient.patient) {
                        await this.fetchPatient(patient.patient);
                    } else {
                        console.error('Patient ID not found in the data', patient);
                    }
                }

                console.log("Successfully fetched patients:", this.assignedPatients);
            } catch (error) {
        ...
        async fetchPatient(id) {
            try {
                ...
                // Ensure assignedPatients is an array
