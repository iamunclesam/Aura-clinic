<template>
    <main>
        <dashboardVue title="All Doctors" />
                    ...
                    <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                        <div
                            ...
                            <div class="flex items-center flex-1 space-x-4">
                                <h5>
                                    <span class="text-gray-500">All Doctors: </span>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Doctor Id</th>
                                ...
                                <tbody>
                                    <tr @click="goToLink(doctor._id)" v-for="(doctor, index) in doctors" :key="index" class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-2">
                                            <span
                                                class="bg-primary-100 text-primary-800 text-md font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ doctor._id}}</span>
                                        </td>
                                        <th scope="row"
...
export default {
    ...
    methods: {
        ...
        goToLink(doctorId) {
            this.$router.push(`/doctor/${doctorId}/details`)
        }
    }
}
</script>
