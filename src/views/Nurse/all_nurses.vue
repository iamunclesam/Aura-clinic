<template>
    <main>
        <dashboardVue title="All Nurses" />


        <div class="sm:ml-64 p-4">
            <section class="dark:bg-gray-900 sm:py-1">
                    ...
                    <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                        <div
                            ...
                            <div class="flex items-center flex-1 space-x-4">
                                <h5>
                                    <span class="text-gray-500">All Nurses: </span>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">nurse Id</th>
                                        <th scope="col" class="px-4 py-3">nurse Name</th>
                                ...
                                <tbody>
                                    <tr @click="goToLink(nurse._id)" v-for="(nurse, index) in nurses" :key="index" class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-4 py-2">
                                            <span
                                                class="bg-primary-100 text-primary-800 text-md font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ nurse._id}}</span>
                                        </td>
                                        <th scope="row"
                                            class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
                                                alt="iMac Front Image" class="w-auto h-10 mr-3 rounded-full">
                                            {{nurse.name}}&#34;
                                        </th>
                                        <td
                                        ...
                                        <td
                                            class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white ">
                                            <span
                                                class="bg-purple-500 text-xs text-white font-medium me-2 px-2.5 py-0.5">
                                                onleave </span>
                                        </td>
                        ...
                        <div class="p-3">
                            ...
                            <button type="button"
                                class="text-white bg-indigo-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
export default {
    ...
    methods: {
        async fetchAllNurses() {
            try {
                const response = await ApiService.getAllNurses();
        ...
        goToLink(nurseId) {
            this.$router.push(`/nurse/${nurseId}/details`)
        }
    }
}
</script>
